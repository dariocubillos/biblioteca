...
CREATE TABLE `settings` (
  `FieldName` char(30) primary key,
  `Value` char(250) DEFAULT NULL
) ENGINE=MyISAM;
#...done.
CREATE TABLE `borrowedbooks` (
  `IDprestamo` int(15) primary key NOT NULL AUTO_INCREMENT ,
  `fkbook` varchar(15) NOT NULL,
  `fkuser` varchar(20) NOT NULL,
  `date` DATETIME DEFAULT CURRENT_TIMESTAMP,  
  `datedelivery` DATETIME DEFAULT NULL,
  `estate` ENUM ('RESERVADO','PRESTADO','RETRASADO','PERDIDO'),
  	CONSTRAINT FK_Book FOREIGN KEY (fkbook)
...
INSERT INTO bvm.books VALUES (9781590595053, 'Pro MySQL', 'Michael Kruckenberg, Jay Pipes and Brian Aker', 5, 1, 'bcs01.gif', NULL, 798, 49.99, '2005-07-15');
INSERT INTO bvm.books VALUES (9781590593325, 'Beginning MySQL Database Design and Optimization', 'Chad Russell and Jon Stephens', 6, 2, 'bcs02.gif', NULL, 520, 44.99, '2004-10-28');
INSERT INTO bvm.books VALUES (9781893115514, 'PHP and MySQL 5', 'W. Jason Gilmore', 4, 3, 'bcs03.gif', NULL, 800, 39.99, '2004-06-21');
INSERT INTO bvm.books VALUES (9781590593929, 'Beginning PHP 5 and MySQL E-Commerce', 'Cristian Darie and Mihai Bucica', 5, 4, 'bcs04.gif', NULL, 707, 46.99, '2008-02-21');
INSERT INTO bvm.books VALUES (9781590595091, 'PHP 5 Recipes', 'Frank M. Kromann, Jon Stephens, Nathan A. Good and Lee Babin', 8, 5, 'bcs05.gif', NULL, 672, 44.99, '2005-10-04');
INSERT INTO bvm.books VALUES (9781430227939, 'Beginning Perl', 'James Lee', 3, 6, 'bcs06.gif', NULL, 464, 39.99, '2010-04-14');
INSERT INTO bvm.books VALUES (9781590595350, 'The Definitive Guide to MySQL 5', 'Michael Kofler', 2, 7, 'bcs07.gif', NULL, 784, 49.99, '2005-10-04');
INSERT INTO bvm.books VALUES (9781590595626, 'Building Online Communities with Drupal, phpBB, and WordPress', 'Robert T. Douglass, Mike Little and Jared W. Smith', 1, 8, 'bcs08.gif', NULL, 560, 49.99, '2005-12-16');
INSERT INTO bvm.books VALUES (9781590595084, 'Pro PHP Security', 'Chris Snyder and Michael Southwell', 7, 9, 'bcs09.gif', NULL, 528, 44.99, '2005-09-08');
INSERT INTO bvm.books VALUES (9781590595312, 'Beginning Perl Web Development', 'Steve Suehring', 8, 10, 'bcs10.gif', NULL, 376, 39.99, '2005-11-07');
# Blob data for table books:
UPDATE bvm.books SET `Description` = "Pro MySQL is the first book that exclusively covers intermediate and advanced features of MySQL, the worldÕs most popular open source database server. Whether you are a seasoned MySQL user looking to take your skills to the next level, or youre a database expert searching for a fast-paced introduction to MySQLÕs advanced features, this book is for you." WHERE `ISBN` = 978-1590595053;
UPDATE bvm.books SET `Description` = "Beginning MySQL Database Design and Optimization shows you how to identify, overcome, and avoid gross inefficiencies. It demonstrates how to maximize the many data manipulation features that MySQL includes. This book explains how to include tests and branches in your queries, how to normalize your database, and how to issue concurrent queries to boost performance, among many other design and optimization topics. YouÕll also learn about some features new to MySQL 4.1 and 5.0 like subqueries, stored procedures, and views, all of which will help you build even more efficient applications." WHERE `ISBN` = 978-1590593325;
...
UPDATE bvm.books SET `Description` = "This is a book for those of us who believed that we didnÕt need to learn Perl, and now we know it is more ubiquitous than ever. Perl is extremely flexible and powerful, and it isnÕt afraid of Web 2.0 or the cloud. Originally touted as the duct tape of the Internet, Perl has since evolved into a multipurpose, multiplatform language present absolutely everywhere: heavy-duty web applications, the cloud, systems administration, natural language processing, and financial engineering. Beginning Perl, Third Edition provides valuable insight into PerlÕs role regarding all of these tasks and more." WHERE `ISBN` = 978-1430227939;
